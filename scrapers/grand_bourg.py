...
class GranBourgScraper(BaseScraper):
    LOCALIDAD = "Malvinas Argentinas"
    CONFIANZA = 3
    FUENTE = "https://www.malvinasargentinas.gob.ar/farmaciasturno"
    FILE_PATH = r"sources\malvinas_argentinas\farmacias_turno_grandbourg_junio.json"
    ...
    def fetch(self):
        ...
        print(f"[GRAND BOURG] Farmacias cargadas desde archivo: {len(farmacias)}")
        return farmacias
