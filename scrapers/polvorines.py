...
class PolvorinesScraper(BaseScraper):
    LOCALIDAD = "Malvinas Argentinas"
    CONFIANZA = 3
    FUENTE = "https://www.malvinasargentinas.gob.ar/farmaciasturno"
    FILE_PATH = "sources/malvinas_argentinas/farmacias_turno_polvorines_junio.json"
    ...
    def fetch(self):
        ...
        print(f"[POLVORINES] Farmacias cargadas desde archivo: {len(farmacias)}")
        return farmacias
